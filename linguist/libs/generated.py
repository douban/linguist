...
CYTHON_COMPILED_EXT_NAMES = ('.c', '.cpp')
...
class Generated(object):
    ...
    def _is_generated(self):
        return self.name == "Gemfile.lock" \
                    ...
                    or self.is_compiled_cython_file
    ...
    @property
    def is_compiled_cython_file(self):
        """
        ...
        Return true or false
        """
        if self.ext_name not in CYTHON_COMPILED_EXT_NAMES:
            return False
        lines = self.lines
        if len(lines) < 1:
            return False
        return "Generated by Cython" in lines[0]
